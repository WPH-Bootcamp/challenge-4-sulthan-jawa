...
function addTodo() {
  ...
  const input = prompt("Enter a to-do: ");
...
function markTodoCompleted() {
  ...
  const input = prompt("Enter the number of the to-do to complete: ");
  const num = parseInt(input);

  if (!num || num < 1 || num > todos.length) {
    console.log(
